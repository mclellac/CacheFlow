...
class Window(Adw.ApplicationWindow):
    ...
    animation_button = Gtk.Template.Child()
    ...
    def __init__(self, **kwargs):
        ...
        self.animation_button.connect(
            "toggled", self.on_animation_toggled
        )
    ...
    def on_animation_toggled(self, button):
        """Callback for when the animation button is toggled.
