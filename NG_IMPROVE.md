...
- **Diff Logic**: Currently indicates differences solely by bolding the text. Colors should also be used to note that there are differences. It compares the current layer against the *next* layer in the list (upstream).
